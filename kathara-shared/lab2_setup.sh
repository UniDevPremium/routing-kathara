...
# r1-anomalo = O : 130.63.255.200/30
echo -e "ip addr add 130.63.186.34/25 dev eth0\
\nip addr add 130.63.255.202/30 dev eth1\
\nip route add default via 130.63.186.1 dev eth0 # r8" > anomalo.startup
...
\nip addr add 130.63.255.201/30 dev eth5\
\n\nip route add default via 130.63.255.254 dev eth4\
\nip route add 130.63.186.34 via 130.63.255.202 dev eth5 # rotta specifica per anomalo\
...
\nip route add 130.63.255.220/28 via 130.63.255.206 dev eth0 # r2r3 , r3r4 (r2r9,r4r5) to r2 da cambiare\
...
\n\nip route add 130.63.186.34 via 130.63.255.205 dev eth4 # rotta specifica per anomalo\
...
\n\nip route add 130.63.186.34 via 130.63.255.209 dev eth4 # rotta specifica per anomalo\
...
\n\nip route add 130.63.186.34 via 130.63.255.213 dev eth4 # rotta specifica per anomalo\
...
\n\nip route add 130.63.186.34 via 130.63.255.217 dev eth4 # rotta specifica per anomalo\
